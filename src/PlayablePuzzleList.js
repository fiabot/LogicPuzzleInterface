...
export default PuzzleList= ({puzzles, setPuzzles, user, reload, showMutants=false, appMode="mixed"}) => {
    ...
    let puzzleList = puzzles.map((puzzle, idx) => {
        ...
        {puzzleList} 
            ...
            return <SelectedPuzzle puzzle={selectedPuzzle} setPuzzle={setSelectedPuzzle} user={user} appMode={appMode} r={() => setMode("view")} reload={reload} otherPuzzles={otherPuzzles} /> 
        }
