...
const START_EVOLVE = API_URL + "/startEvolution"
const CONTINUE_EVOLVE = API_URL + "/continueEvolution"
const REMOVE_PUZZLE = API_URL + "/remove_puzzle"
const UPDATE_PUZZLE = API_URL + "/update_puzzle"
const NEW_SESSION = API_URL + "/new_session"
const NEW_SCENARIO = API_URL + "/createScenario"
const UPDATE_SCEN = API_URL + "/updateScenario"
const GET_SCENARIOS = API_URL + "/getScenarios"
const GET_EVOLVE_SESSION = API_URL + "/getEvolveSession"
const GET_EXAMPLES = API_URL + "/getExamples"
// TO ADD 
...
const CREATE_GUEST = API_URL + "/create_guest"
